        ...
        {totalItems > 0 && (
          ...
          >
            <button
              ...
              className="relative flex items-center gap-2 bg-accent text-accent-foreground pl-3 pr-4 py-2.5 rounded-full font-heading font-semibold text-sm shadow-lg hover:opacity-90 transition-all active:scale-95"
            >
