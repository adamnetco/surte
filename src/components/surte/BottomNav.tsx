          ...
          return (
            ...
            >
              <div className="relative">
                ...
                {isCart && totalItems > 0 && (
                  <span className="absolute -top-2 -right-2.5 bg-surte-orange text-primary-foreground text-[10px] font-bold w-4.5 h-4.5 flex items-center justify-center rounded-full min-w-[18px] h-[18px]">
                    {totalItems}
                  </span>
                )}
              </div>
